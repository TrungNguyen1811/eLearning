<%-- 
    Document   : Login
    Created on : Jan 5, 2022, 8:14:52 PM
    Author     : ductd
--%>
...
<html>
    <head>
        ...
        <title>Login | Online Learn</title>
    ...
    <body>
        ...
        <c:if test = "${requestScope.check}">
            <div class="alert-box warning"><span><img style="border-radius: 16px;" src="images/login/warning.png" alt=""/>  Warning: </span>Email or Password that you've entered is incorrect. Please re-Enter.</div>
                </c:if>
        <div style="padding-right: 300px;" class="container">
            <div class="row">
                <div class="logo"><img style="" src="images/login/Logo.png" alt=""/></div>
                <div class="col-sm-4 col-sm-offset-8" >
                    <div class="login-form">
                        <h2>Login to your account</h2>
                        <form action="login_controller" method="post">
                            <input type="email" name="email" placeholder="Email Address" required="" />
                            <input type="password" name="password" placeholder="Enter Pasword" minlength="3" maxlength="12" required=""/>
