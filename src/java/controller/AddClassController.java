...
public class AddClassController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        ClassDetaiDAO classDetaiDAO = new ClassDetaiDAO();
        ...
        for (ClassList listClas : listClass) {
            if (listClas.getName().equalsIgnoreCase(name)) {
                ...
                request.getRequestDispatcher("AddClassList.jsp").forward(request, response);
                return;
            }
        }
        classDetaiDAO.insertClass(name, teacher, status);
