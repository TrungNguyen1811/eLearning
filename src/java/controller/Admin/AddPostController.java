...
public class AddPostController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/Admin/add_post.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Post data = new Post();
            data.setCategory(new CategoryDAO().getById(cateId));
            data.setTitle(title);
            ...
            data.setAuthor(new AccountDAO().getById(1));
            new PostDAO().insert(data);
