            ...
            <div class="row">
                <div class="col-sm-9 padding-right">
                    <div class="features_items"><!--features_items-->
                        <h2 class="title text-center">Latest Courses</h2>
                        <c:forEach begin="0" end="5" items="${top1_course}" var="o">
                            <div class="col-sm-4">
                                <div class="product-image-wrapper">
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="images/login/${o.thumbnail}" alt="" />
                                            <h2>${o.salePrice}</h2>
                                            <p>${o.title}</p>
                                            <a href="cart.html" target="_blank" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Buy Now</a>
                                        </div>
                                        <div class="product-overlay">
                                            <div class="overlay-content">
                                                <p>${o.introduction}</p>
                                                <a href="product-details.html" target="_blank" class="btn btn-default add-to-cart">More Details</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="category-tab"><!--category-tab-->
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade active in">
                                <c:forEach begin="0" end="1" items="${blogs}" var="o">
                                    <div class="col-sm-12 clients">
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <blockquote>
                                                    &#8212; ${o.short_detail}
                                                    <a href="blog_single_controller?id=${o.id}" target="_blank">More Details</a>
                                                    <hr class="clients-hr">
                                                </blockquote>
                                            </div>
                                        </div>
