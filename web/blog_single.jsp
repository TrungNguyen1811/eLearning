<%-- 
    Document   : Blog
    Created on : Jan 20, 2022, 10:11:36 AM
    Author     : LENOVO
--%>
                            ...
                            <div class="single-blog-post">
                                ...
                                <div class="post-meta">
                                    <ul>
                                        ...
                                        <li><i class="fa fa-clock-o"></i> ${blog_single.updated_date}</li>
                                        <li><i class="fas fa-code"></i> ${post_content.name}</li>
                                    </ul>
                                </div>
                                <a href="">
                                    <img src="images/blog/${blog_single.image}" alt="">
                                </a>
                                <p>
                                    ${blog_single.detail}
                                </p>
