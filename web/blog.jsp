<%-- 
    Document   : Blog
    Created on : Jan 24, 2022, 10:02:04 AM
    Author     : LENOVO
--%>
                ...
                <div class="row">
                    <div class="col-sm-9">
                        <div class="blog-post-area">
                            ...
                            <c:forEach items="${blog_list}" var="o">
                                <div class="single-blog-post">
                                    <h3>${o.title}</h3>
                                    <div class="post-meta">
                                        <ul>
                                            <li><i class="fa fa-user"></i> ${o.author_name}</li>
                                            <li><i class="fa fa-clock-o"></i> ${o.updated_date}</li>
                                            <li><i class="fa fa-calendar"></i> ${o.blog_category_name}</li>
                                        </ul>
                                    </div>
                                    <a href="">
                                        <img src="images/blog/${o.image}" alt="">
                                    </a>
                                    <p>${o.short_detail }</p>
                                    <a  class="btn btn-primary" href="blog_single_controller?id=${o.id}" target="_blank">Read More</a>
                                </div>
                            </c:forEach>
                            ...
                            <div class="pagination-area">
                                <ul class="pagination">
                                    <c:forEach begin="1" end="${endPage}" var="o">
                                        <li><a href="blog_list_controller?index=${o}&cateId=${cateId}">${o}</a></li>
                                        </c:forEach>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-sm-3">
                        <form action="blog_list_controller" method="post">
                            <div class="search_box">
                                <input type="text" placeholder="Search" name="text"/>
                                <button  class="btn btn-primary" type="submit"> <i class="fa fa-search"></i></button>
                            </div>
                        </form>
                        <h2><a href="blog_list_controller">BLog Content</a></h2>
                        <div class="panel-group category-products" id="accordian"><!--category-productsr-->
                            <c:forEach items="${blog_category_list}" var="o">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title"><a href="blog_list_controller?id=${o.id}">${o.name}</a></h4>
                                    </div>
                                </div>
                            </c:forEach>
                        </div>
